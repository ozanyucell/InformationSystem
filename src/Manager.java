public class Manager extends Employee implements IMenu{
    ...
    Manager(String ID,String name, String workHour, String bornDate, String title, double height, double weight, double salary, int age, String officeLocation, String officeHours)
    {
    ...
    public void Menu() {
        ...
        System.out.println("4. Make an announcement.");
        System.out.println("5. Sick reports");
